...
export const artigosComunidade = [
  ...
  { titulo: "Levei a reciclagem para a escola dos meus filhos", autor: "Diego Andrade", tag: "participante", icone: <FaGraduationCap />, cor: "c" },
];
...
export const guias = [
  ...
  { titulo: "Compostagem doméstica", nivel: "Intermediário", aulas: 8, duracao: "1 h 10 min", icone: <FaBookOpen /> },
